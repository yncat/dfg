...
export class GameState extends Schema {
    ...
    @type([ "string" ]) public playerNameList: ArraySchema<string> = new ArraySchema<string>();
    ...
    @type([ DiscardPair ]) public discardStack: ArraySchema<DiscardPair> = new ArraySchema<DiscardPair>();
    @type([ RemovedCardEntry ]) public removedCardList: ArraySchema<RemovedCardEntry> = new ArraySchema<RemovedCardEntry>();
    @type(RuleConfig) public ruleConfig: RuleConfig = new RuleConfig();
    @type([ EventLog ]) public eventLogList: ArraySchema<EventLog> = new ArraySchema<EventLog>();
}
